...
SUFFIXES={'vmx-re':('.qcow2','.vmdk','.raw'),'vmx-mpc':('.qcow2','.vmdk','.raw'),'vptx-cspp':('.qcow2','.vmdk','.raw'),'linux':('.qcow2','.vmdk','.raw'),'modem':('.qcow2','.vmdk','.raw')}

PRIORITY={'vmx-re':1,'vmx-mpc':2,'vptx-re':3,'vptx-cspp':4,'linux':5,'modem':6}
